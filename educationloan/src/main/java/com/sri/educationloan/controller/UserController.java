package com.sri.educationloan.controller;
...
import com.sri.educationloan.model.UserModel;
import com.sri.educationloan.service.UserService;
...
public class UserController {
		...
		public void Del(@PathVariable("id") int num)
		{
			userSer.Del(num);
		}
